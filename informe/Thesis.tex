...
\input{chapters/declaracion_ia.tex}
...
\input{chapters/descripcion_problema.tex}

\chapter{Discusión metodológica} \label{ch:metodologia}
\input{chapters/metodologia.tex}

\chapter{Implementación y herramientas} \label{ch:implementacion}
